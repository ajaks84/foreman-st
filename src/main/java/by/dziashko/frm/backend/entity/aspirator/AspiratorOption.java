...
@Entity
public class AspiratorOption extends AbstractEntity implements Cloneable{

    private String modelName = "";

    @OneToMany(mappedBy = "aspiratorOption", fetch = FetchType.EAGER)
    private List<AspiratorData> aspiratorDataList = new LinkedList<>();

    public AspiratorOption() {
    }
