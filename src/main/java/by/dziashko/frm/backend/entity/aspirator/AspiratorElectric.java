...
@Entity
public class AspiratorElectric extends AbstractEntity implements Cloneable{

    private String modelName = "";

    @OneToMany(mappedBy = "aspiratorElectric", fetch = FetchType.EAGER)
    private List<AspiratorData> aspiratorDataList = new LinkedList<>();

    public AspiratorElectric() {
    }
